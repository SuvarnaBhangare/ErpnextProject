...
frappe.query_reports["General Ledger (Cost Center And Project)"] = {
	"filters": [
		{
			"fieldname":"company",
			"label": __("Company"),
		...
		},
		{
			...
			"fieldtype": "Data",
			on_change: function() {
				frappe.query_report.set_filter_value('group_by', "Group by Account");
			}
		},
		{
		...
		},
		{
			...
			get_data: function() {
				...
				if(frappe.query_report.get_filter_value('party_type')==""){
					frappe.msgprint("Please Select <b>Party Type</b> First To Filter Party.")
				}
